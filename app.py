...
class CustomerDf(db.Model):
    ...
    Education = db.Column(db.String(120), unique=False, nullable=False)
    ...
    MaritalStatus = db.Column(db.String(120), unique=False, nullable=False)
    CreditAmount = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_1 = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_2 = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_3 = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_4 = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_5 = db.Column(db.Integer, unique=False, nullable=False)
    Rpay_Status_6 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_1 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_2 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_3 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_4 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_5 = db.Column(db.Integer, unique=False, nullable=False)
    Statement_6 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_1 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_2 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_3 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_4 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_5 = db.Column(db.Integer, unique=False, nullable=False)
    Payment_6 = db.Column(db.Integer, unique=False, nullable=False) 
    Default_pay = db.Column(db.Integer, unique=False, nullable=False)
    Default_Status = db.Column(db.String(120), unique=False, nullable=False)
